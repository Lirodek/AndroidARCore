        ...
        MainRenderer.RenderCallBack mr = new MainRenderer.RenderCallBack() {
            ...
            public void preRender() {
                ...
                if(mTouch == true){
                    ...
                    hitResult = frame.hitTest(displayX, displayY);

                    Log.d("MainActivity", "건드렸다"+displayX+", "+displayY+ ",hit result" + hitResult);
                    int i=0;
                    for(HitResult hr : hitResult){
